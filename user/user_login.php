...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a id="adminLoginBtn" class="btn btn-outline-light" href="../admin/admin_login.php">Admin Login</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="container d-flex justify-content-center">
        <div class="login-container">
            ...
            <h5 class="mt-3 text-center">User Login</h5>
            <form method="POST">
    ...
    <?php if ($success): ?>
        <script>
            Swal.fire({
                ...
                text: 'You will be redirected to your page.',
                showConfirmButton: false,
                timer: 2000
            }).then(() => {
                window.location.href = 'user_cars.php';
            });
        </script>
    <?php endif; ?>
